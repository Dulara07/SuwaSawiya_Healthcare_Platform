        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            {user ? <div className="flex items-center space-x-3 ml-4 border-l pl-4 border-gray-200">
                ...
                <Button variant="ghost" size="sm" onClick={() => login('donor')}>User Login</Button>
                <Button variant="primary" size="sm" onClick={() => login('partner')}>Admin Login</Button>
              </div>}
          </div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {!user && <div className="pt-4 pb-2 border-t border-gray-100 mt-2">
                <div className="space-y-2 px-3">
                  <Button fullWidth variant="outline" onClick={() => { login('donor'); setIsMenuOpen(false); }}>Donor Login</Button>
                  <Button fullWidth variant="primary" onClick={() => { login('partner'); setIsMenuOpen(false); }}>Admin</Button>
                </div>
              </div>}
