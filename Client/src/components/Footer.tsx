        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Connecting compassionate hearts with those in critical need.
              Secure, transparent, and direct medical crowdfunding.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/partner/register" className="text-gray-400 hover:text-white text-sm">
                  Partner with Us
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400 text-sm">
                  123 Hospital Road, Colombo 07, Sri Lanka
                </span>
              </li>
