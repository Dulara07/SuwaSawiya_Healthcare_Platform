...
export function PartnerDashboardPage() {
  ...
  const totalRaised = myCampaigns.reduce((acc, curr) => acc + (curr.raised_amount || curr.raisedAmount || 0), 0);
  ...
  return <div className="bg-gray-50 min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <NewCampaignModal isOpen={modalOpen} onClose={() => setModalOpen(false)} onSuccess={handleModalSuccess} />
